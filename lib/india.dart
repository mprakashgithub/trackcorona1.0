                ...
                if(index==0) {
                  ...
                  return Card(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Container(alignment: Alignment.center,color: Colors.deepPurple, padding: EdgeInsets.all(5), child: Text('Total Corona cases', style: TextStyle(fontSize: 22, color: Colors.white, fontWeight: FontWeight.bold))),
                          Divider(color: Colors.white,),
                          Container(alignment: Alignment.center,color: Colors.indigo, padding: EdgeInsets.all(5), child: Text('Updated on ' + date +' at '+time, style: TextStyle(fontSize: 16, color: Colors.white))),
                          Container(
                            padding: EdgeInsets.all(5),
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Container(alignment: Alignment.topLeft, child: Text('Recovered: ' + recovered, style: TextStyle(fontSize: 18, color: Colors.white))),
                              ],
                            ),
                          ),
                          Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                              children: <Widget>[
                                Container(alignment: Alignment.topLeft, child: Text('Deaths: ' + deaths, style: TextStyle(fontSize: 18, color: Colors.red[800]))),
                                Container(alignment: Alignment.topLeft, child: Text('Active: ' + active, style: TextStyle(fontSize: 18, color: Colors.white))),
                              ],
                            ),
                          ),
                        ],
